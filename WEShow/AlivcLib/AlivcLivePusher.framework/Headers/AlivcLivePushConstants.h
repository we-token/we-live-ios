...
Image format
 */
typedef NS_ENUM(NSInteger, AlivcLivePushImageFormat){
    AlivcLivePushImageFormatUnknown   = -1,
    AlivcLivePushImageFormatBGR       = 0,
    AlivcLivePushImageFormatRGB,
    AlivcLivePushImageFormatARGB,
    AlivcLivePushImageFormatBGRA,
    AlivcLivePushImageFormatRGBA,
    AlivcLivePushImageFormatYUV420P,
    AlivcLivePushImageFormatYUVYV12,
    AlivcLivePushImageFormatYUVNV21,
    AlivcLivePushImageFormatYUVNV12,
    AlivcLivePushImageFormatYUVJ420P,
    AlivcLivePushImageFormatYUVJ420SP,
    AlivcLivePushImageFormatYUVJ444P,
    AlivcLivePushImageFormatYUV444P,
};
...
/**
 sound format
 */
typedef NS_ENUM(NSInteger, AlivcLivePushSoundFormat){
    AlivcLivePushSoundFormatUnknown   = -1,
    AlivcLivePushSoundFormatU8       = 0,
    AlivcLivePushSoundFormatS16,
    AlivcLivePushSoundFormatS32,
    AlivcLivePushSoundFormatF32,
    AlivcLivePushSoundFormatU8P,
    AlivcLivePushSoundFormatS16P,
    AlivcLivePushSoundFormatS32P,
    AlivcLivePushSoundFormatF32P,
};
